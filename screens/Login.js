  ...
  handleOnLogin = async (values, actions) => {
    ...
    try {
      ...
      if (response.user) {
       ...
       firebase.database().ref(`users/followers/`+response.user.uid).on('value',(snapshot)=>
        {
        ...
        firebase.database().ref(`users/brand/`+response.user.uid).on('value',(snapshot)=>
        {
        ...
        firebase.database().ref(`users/mandor/`+response.user.uid).on('value',(snapshot)=>
        { 
