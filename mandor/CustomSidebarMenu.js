    ...
    this.items = [
      {
        ...
        navOptionName: 'Home',
        screenToNavigate: 'MandorHome',
      },
      {
        navOptionThumb: 'message',
        navOptionName: 'Messages',
        screenToNavigate: 'MandorMessages',
      },
      {
        navOptionThumb: 'event',
        navOptionName: 'Settings',
        screenToNavigate: 'MandorSettings',
      },
      {
        navOptionThumb: 'flare',
        navOptionName: 'Post',
        screenToNavigate: 'NavScreen7',
      },
      {
        navOptionThumb: 'list',
        navOptionName: 'Brands',
        screenToNavigate: 'MandorBrands',
      },
      {
        navOptionThumb: 'exit-to-app',
        navOptionName: 'Logout',
        screenToNavigate: 'MandorLogout',
      }
